---
layout: post
title: 'What Does It Take to Be a Senior Software Engineer / Developer?'
image: /resources/images/og-image.png
cover: https://r2.caponte.io/resources/images/posts/senior/cover.webp
...
After discussing with some experienced friends and the [SWE community on X](https://x.com/0xCaponte/status/1835369019324424479){:target="_blank"} (formerly Twitter), I decided to summarize this collective wisdom and share the key qualities and skills needed to reach a senior level and be good at it. These points are in no particular order, and I would recommend taking them as a whole and addressing them to find the right balance for your environment, current skills, and weaknesses (yes, you should address those too).
...
2. When talking to non-technical people, speak their language and about things they care about. For example:
...
[How To Grow As a Junior Developer To Senior - 5 Tips](https://youtu.be/JoU_CZWOoo0) - Travis Media

[Reaching Senior Software Engineer in Big Tech (Google, Amazon, Microsoft, FAANG)](https://youtu.be/B3O__6UIAVI) - The Deliberate Engineer
